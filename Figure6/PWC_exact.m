function [Y] = PWC_exact(t, Ifunc, Area, Na_mask,K_mask,NaNoise1,KNoise1)
...
% Conductance Noise Model using Euler Maruyama (Thomas and Pu)
    ...
    % D is symmetric, eigenvalue decomposition is a more natural choice By
    % Pu 04/10/2019
...
%         DiffMatrixNum=sum(sum(DiffMatrix))
        %pause
        %Na_gates1 = Na_gates1 + dt*ANa(V1)*Na_gates1 + real(SNa(V1,Na_gates1,NNa))*R_noise;
       Na_gates1 = Na_gates1 + dt*ANa(V1)*Na_gates1 + Fox*R_noise;
